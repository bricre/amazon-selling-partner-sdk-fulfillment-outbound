# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner APIs for Fulfillment Outbound
...
```shell
composer require bricre/amazon-selling-partner-sdk-fulfillment-outbound
```
...
```php
<?php
use Amz\FulfillmentOutbound\ResponseTypes;
